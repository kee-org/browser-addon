//TODO: See if we can animate icons in a service worker / background page. Maybe new options now like a gif?
...
//         if (!smooth) {
//             this.timer = global.setInterval(() => this.drawLowFramerate(), interval);
//             return;
//         }
