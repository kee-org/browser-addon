// For more accurate testing, keep this file up to date with the globally polluting dependencies if they change.
// 1) tp/punycode.js
// 2) pslData.js
// 3) tp/publicsuffixlist.min.js
...
global.pslData = {
    ...
    *.ye
    ...
    // List of new gTLDs imported from https://www.icann.org/resources/registries/gtlds/v2/gtlds.json on 2020-06-24T16:52:00Z
...
}i=i||window;i.publicSuffixList={version:"1.0",parse:f,getDomain:l,getPublicSuffix:e,toSelfie:c,fromSelfie:a}})(global);
