// Type definitions for WebExtensions extension development
// Based upon Google Chrome type definitions, modified to use the browser
// namespace (use a polyfill for Google Chrome runtime support), expanded
// to support Promises and a few other use cases the existing definitions
// didn't support.
...
declare namespace browser.accessibilityFeatures {
    ...
    interface AccessibilityFeaturesSetting {
        ...
        get(details: AccessibilityFeaturesGetArg): Promise<AccessibilityFeaturesCallbackArg>;
        /**
...
declare namespace browser.browserAction {
    ...
    export function getBadgeBackgroundColor(details: TabDetails): Promise<number[]>;
    /**
     * Since Chrome 19.
...
declare namespace browser.contentSettings {
    ...
    interface ContentSetting {
        ...
        getResourceIdentifiers(): Promise<ResourceIdentifier[]>;
        /**
        ...
        get(details: GetDetails): Promise<ReturnedDetails>;
    }
...
// declare module browser.debugger {
...
//     }
//
//     interface DebuggerDetachedEvent extends events.Event<(source: Debuggee, reason: string) => void> {}
//
//     interface DebuggerEventEvent extends events.Event<(source: Debuggee, method: string, params?: Object) => void> {}
//
//     /**
...
declare namespace browser.declarativeWebRequest {
    ...
    interface RequestedEvent extends events.Event<Function> {}
...
declare namespace browser.desktopCapture {
    ...
    export function chooseDesktopMedia(sources: string[]): Promise<string>;
    /**
     * Shows desktop media picker UI with the specified set of sources.
     * @param sources Set of sources that should be shown to the user.
     ...
     * Parameter streamId: An opaque string that can be passed to getUserMedia() API to generate media stream that corresponds to the source selected by the user. If user didn't select any source (i.e. canceled the prompt) then the callback is called with an empty streamId. The created streamId can be used only once and expires after a few seconds when it is not used.
     */
    export function chooseDesktopMedia(sources: string[], targetTab: tabs.Tab, callback: (streamId: string) => void): number;
    export function chooseDesktopMedia(sources: string[], targetTab: tabs.Tab): Promise<string>;
    /**
...
declare namespace browser.devtools.inspectedWindow {
    ...
    export function eval(expression: string): Promise<EvaluationExceptionInfo>;
    /**
...
declare namespace browser.devtools.panels {
    ...
    export function setOpenResourceHandler(): Promise<devtools.inspectedWindow.Resource>;
    /**
     * Since Chrome 38.
...
declare namespace browser.documentScan {
    ...
    export function scan(options: DocumentScanOptions): Promise<DocumentScanCallbackArg>;
}
...
declare namespace browser.fileBrowserHandler {
    ...
    interface FileBrowserHandlerExecuteEvent extends events.Event<(id: string, details: FileHandlerExecuteEventDetails) => void> {}
    ...
    export function selectFile(selectionParams: SelectionParams): Promise<SelectionResult>;
...
declare namespace browser.fileSystemProvider {
    ...
    interface RequestedEvent extends events.Event<(options: RequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

    interface MetadataRequestedEvent extends events.Event<(options: MetadataRequestedEventOptions, successCallback: (metadata: EntryMetadata) => void, errorCallback: (error: string) => void) => void> {}

    interface DirectoryPathRequestedEvent extends events.Event<(options: DirectoryPathRequestedEventOptions, successCallback: (entries: EntryMetadata[], hasMore: boolean) => void, errorCallback: (error: string) => void) => void> {}

    interface OpenFileRequestedEvent extends events.Event<(options: OpenFileRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

    interface OpenedFileRequestedEvent extends events.Event<(options: OpenedFileRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

    interface OpenedFileOffsetRequestedEvent extends events.Event<(options: OpenedFileOffsetRequestedEventOptions, successCallback: (data: ArrayBuffer, hasMore: boolean) => void, errorCallback: (error: string) => void) => void> {}

    interface DirectoryPathRecursiveRequestedEvent extends events.Event<(options: DirectoryPathRecursiveRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

    interface EntryPathRecursiveRequestedEvent extends events.Event<(options: EntryPathRecursiveRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

    interface FilePathRequestedEvent extends events.Event<(options: FilePathRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

    interface SourceTargetPathRequestedEvent extends events.Event<(options: SourceTargetPathRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

    interface FilePathLengthRequestedEvent extends events.Event<(options: FilePathLengthRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

    interface OpenedFileIoRequestedEvent extends events.Event<(options: OpenedFileIoRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

    interface OperationRequestedEvent extends events.Event<(options: OperationRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

    interface OptionlessRequestedEvent extends events.Event<(successCallback: Function, errorCallback: (error: string) => void) => void> {}
...
declare namespace browser.fontSettings {
    ...
    interface DefaultFixedFontSizeChangedEvent extends events.Event<(details: FontSizeDetails) => void> {}

    interface DefaultFontSizeChangedEvent extends events.Event<(details: FontSizeDetails) => void> {}

    interface MinimumFontSizeChangedEvent extends events.Event<(details: FontSizeDetails) => void> {}

    interface FontChangedEvent extends events.Event<(details: FullFontDetails) => void> {}
    ...
    export function getMinimumFontSize(details?: FontSizeDetails): Promise<FontSizeDetails>;
    /**
...
declare namespace browser.gcm {
    ...
    interface MessageReceptionEvent extends events.Event<(message: IncomingMessage) => void> {}

    interface MessageDeletionEvent extends events.Event<() => void> {}

    interface GcmErrorEvent extends events.Event<(error: GcmError) => void> {}
...
declare namespace browser.input.ime {
    ...
    interface BlurEvent extends events.Event<(contextID: number) => void> {}

    interface CandidateClickedEvent extends events.Event<(engineID: string, candidateID: number, button: string) => void> {}

    interface KeyEventEvent extends events.Event<(engineID: string, keyData: KeyboardEvent) => void> {}

    interface DeactivatedEvent extends events.Event<(engineID: string) => void> {}

    interface InputContextUpdateEvent extends events.Event<(context: InputContext) => void> {}

    interface ActivateEvent extends events.Event<(engineID: string, screen: string) => void> {}

    interface FocusEvent extends events.Event<(context: InputContext) => void> {}

    interface MenuItemActivatedEvent extends events.Event<(engineID: string, name: string) => void> {}

    interface SurroundingTextChangedEvent extends events.Event<(engineID: string, surroundingInfo: SurroundingTextInfo) => void> {}

    interface InputResetEvent extends events.Event<(engineID: string) => void> {}
    ...
    export function setCursorPosition(parameters: CursorPositionParameters): Promise<boolean>;
    /**
...
declare namespace browser.networking.config {
    ...
    interface CaptivePorttalDetectedEvent extends events.Event<(networkInfo: NetworkInfo) => void> {}
...
declare namespace browser.pageCapture {
    ...
    export function saveAsMHTML(details: SaveDetails): Promise<any>;
}
...
declare namespace browser.platformKeys {
    ...
    export function selectClientCertificates(details: ClientCertificateSelectDetails): Promise<Match[]>;
    /**
    ...
    export function getKeyPair(certificate: ArrayBuffer, parameters: Object): Promise<CryptoKey | null>;
    ...
    export function verifyTLSServerCertificate(details: ServerCertificateVerificationDetails): Promise<ServerCertificateVerificationResult>;
}
...
declare namespace browser.printerProvider {
    ...
    interface PrinterRequestedEvent extends events.Event<(resultCallback: (printerInfo: PrinterInfo[]) => void) => void> {}

    interface PrinterInfoRequestedEvent extends events.Event<(device: any, resultCallback: (printerInfo?: PrinterInfo) => void) => void> {}

    interface CapabilityRequestedEvent extends events.Event<(printerId: string, resultCallback: (capabilities: PrinterCapabilities) => void) => void> {}

    interface PrintRequestedEvent extends events.Event<(printJob: PrintJob, resultCallback: (result: string) => void) => void> {}
...
declare namespace browser.scriptBadge {
    ...
    interface ScriptBadgeClickedEvent extends events.Event<(tab: tabs.Tab) => void> {}

    export function getPopup(details: GetPopupDetails, callback: Function): void;
    export function getPopup(details: GetPopupDetails): Promise<void>;
...
declare namespace browser.socket {
    ...
    export function create(type: string, options?: Object): Promise<CreateInfo>;
    ...
    export function connect(socketId: number, hostname: string, port: number): Promise<number>;
    export function bind(socketId: number, address: string, port: number, callback: (result: number) => void): void;
    export function bind(socketId: number, address: string, port: number): Promise<number>;
    ...
    export function read(socketId: number, bufferSize?: number): Promise<ReadInfo>;
    export function write(socketId: number, data: ArrayBuffer, callback?: (writeInfo: WriteInfo) => void): void;
    export function write(socketId: number, data: ArrayBuffer): Promise<WriteInfo>;
    export function recvFrom(socketId: number, bufferSize?: number, callback?: (recvFromInfo: RecvFromInfo) => void): void;
    export function recvFrom(socketId: number, bufferSize?: number): Promise<RecvFromInfo>;
    ...
    export function sendTo(socketId: number, data: ArrayBuffer, address: string, port: number): Promise<WriteInfo>;
    export function listen(socketId: number, address: string, port: number, backlog?: number, callback?: (result: number) => void): void;
    export function listen(socketId: number, address: string, port: number, backlog?: number): Promise<number>;
    export function accept(socketId: number, callback?: (acceptInfo: AcceptInfo) => void): void;
    export function accept(socketId: number): Promise<AcceptInfo>;
    export function setKeepAlive(socketId: number, enable: boolean, delay?: number, callback?: (result: boolean) => void): void;
    export function setKeepAlive(socketId: number, enable: boolean, delay?: number): Promise<boolean>;
    export function setNoDelay(socketId: number, noDelay: boolean, callback?: (result: boolean) => void): void;
    export function setNoDelay(socketId: number, noDelay: boolean): Promise<boolean>;
    export function getInfo(socketId: number, callback: (result: SocketInfo) => void): void;
    export function getInfo(socketId: number): Promise<SocketInfo>;
...
declare namespace browser.system.storage {
    ...
    interface SystemStorageAttachedEvent extends events.Event<(info: StorageUnitInfo) => void> {}

    interface SystemStorageDetachedEvent extends events.Event<(id: string) => void> {}
...
declare namespace browser.tabCapture {
    ...
    interface CaptureStatusChangedEvent extends events.Event<(info: CaptureInfo) => void> {}
    ...
    export function capture(options: CaptureOptions): Promise<MediaStream | null>;
    /**
...
////////////////////
/**
 * Use the tts API to play synthesized text-to-speech (TTS). See also the related ttsEngine API, which allows an extension to implement a speech engine.
 * Permissions:  "tts"
 * @since Chrome 14.
 */
declare namespace tts {
    ...
    export function speak(utterance: string): Promise<void>;
    /**
     * Speaks text using a text-to-speech engine.
     * @param utterance The text to speak, either plain text or a complete, well-formed SSML document. Speech engines that do not support SSML will strip away the tags and speak the text. The maximum length of the text is 32,768 characters.
    ...
    export function speak(utterance: string, options: SpeakOptions): Promise<void>;
    /**
...
declare namespace browser.ttsEngine {
    ...
    interface TtsEngineSpeakEvent extends events.Event<(utterance: string, options: SpeakOptions, sendTtsEvent: (event: tts.TtsEvent) => void) => void> {}
     ...
     * @since Chrome 29.
     */
    var onResume: events.Event<() => void>;
}
...
declare namespace browser.vpnProvider {
    ...
    interface VpnPlatformMessageEvent extends events.Event<(id: string, message: string, error: string) => void> {}

    interface VpnPacketReceptionEvent extends events.Event<(data: ArrayBuffer) => void> {}

    interface VpnConfigRemovalEvent extends events.Event<(id: string) => void> {}

    interface VpnConfigCreationEvent extends events.Event<(id: string, name: string, data: Object) => void> {}

    interface VpnUiEvent extends events.Event<(event: string, id?: string) => void> {}
    ...
    export function setParameters(parameters: VpnSessionParameters): Promise<void>;
    /**
    ...
    export function notifyConnectionStateChanged(state: string): Promise<void>;
...
declare namespace browser.wallpaper {
    ...
    export function setWallpaper(details: WallpaperDetails): Promise<any>;
}
...
declare namespace browser.webNavigation {
    ...
    interface WebNavigationRequestFilter extends webRequest.RequestFilter {
    ...
    interface WebNavigationEvent<T extends WebNavigationCallbackDetails> extends events.Event<(details: T) => void> {
        ...
        addListener(): Promise<WebNavigationRequestFilter>;
    }
...
declare namespace browser.webRequest {
    ...
    //interface WebAuthenticationChallengeEvent extends events.Event<(details: WebAuthenticationChallengeDetails): Promise<BlockingResponse>;
...
declare namespace browser.webstore {
    ...
    interface InstallationStageEvent extends events.Event<(stage: string) => void> {}

    interface DownloadProgressEvent extends events.Event<(percentDownloaded: number) => void> {}
...
declare namespace windows {
     ...
     */
    export function create(callback?: (window?: windows.Window) => void): void;
     ...
     * Optional parameter window: Contains details about the created window.
     */
    export function create(createData: CreateData, callback?: (window?: windows.Window) => void): void;
    export function create(createData: CreateData): Promise<windows.Window>;
    /**
     * Gets all windows.
     */
    export function getAll(callback: (windows: windows.Window[]) => void): void;
    ...
    export function update(windowId: number, updateInfo: UpdateInfo, callback?: (window: windows.Window) => void): void;
