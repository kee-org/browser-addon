...
//                 opt.selected = true;
//             opt.style.backgroundImage = "url(data:image/png;base64," + db.icon.iconImageData + ")";
//             dbOptions.push(opt);
//         }
...
//             opt.setAttribute("value", group.uuid);
//             opt.textContent = group.title;

//             if (mruGroup == group.uuid)
...
//             loginItem.setAttribute("data-uuid", login.uuid);
